  ...
  <div class="flex flex-col lg:flex-row gap-6 lg:gap-10 mb-10">
    ...
    <div class="flex-1 min-w-0">
      <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <button
          class="flex-1 sm:flex-none min-h-11 sm:w-11 inline-flex items-center justify-center gap-2 px-4 sm:px-0 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white border border-border dark:border-border-dark rounded-xl hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
          ...
          <span class="sm:hidden text-sm font-semibold">Edit</span>
        </button>
        <button
          class="flex-1 sm:flex-none min-h-11 sm:w-11 inline-flex items-center justify-center gap-2 px-4 sm:px-0 text-red-500 hover:text-red-600 border border-red-200 dark:border-red-500/30 rounded-xl hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors disabled:opacity-50"
          ...
          <span class="sm:hidden text-sm font-semibold">Delete</span>
        </button>
        </div>
      </div>
      ...
      {#each games as game}
        <a href="/games/{game.id}"
          ...
          <div class="aspect-[3/4] bg-slate-100 dark:bg-white/5 relative">
            ...
            {/if}
            <button
              class="remove-game-button absolute top-2 right-2 w-10 h-10 rounded-xl bg-black/70 backdrop-blur-sm text-white
                     transition-all flex items-center justify-center hover:bg-red-500 focus-visible:bg-red-500"
...
<style>
  @media (hover: hover) and (pointer: fine) {
    ...
    .group:hover .remove-game-button,
    .remove-game-button:focus-visible {
      opacity: 1;
    }
  }
</style>
